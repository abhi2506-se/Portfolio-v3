...
import { Code2, Palette, Database, GitBranch, Zap, Brain } from 'lucide-react'
        ...
        {skills.map((cat, idx) => {
          ...
          return (
            ...
            >
              ...
              <motion.div
                className={`absolute inset-0 bg-gradient-to-br ${cat.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl`}
              />
              {/* Glow dot top-right */}
              <motion.div
